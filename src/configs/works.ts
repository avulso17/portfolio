export const works = [
  ...
  },
  {
    ...
    description:
      'Zeus Agrotech is a 100% Brazilian company, fully committed to the agricultural sector, using advanced technology to capture and analyze information about farm microclimates.',
